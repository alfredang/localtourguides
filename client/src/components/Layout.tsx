      ...
      <footer className="bg-ink text-white/80">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
          <div>
            ...
            <a
              href="https://apps.apple.com/sg/app/localtourguides/id6787895187"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Download on the App Store"
              className="mt-5 inline-flex items-center gap-3 rounded-xl border border-white/20 bg-white/5 px-4 py-2.5 transition hover:border-amber-400/60 hover:bg-white/10"
            >
            ...
            <p className="mt-3 text-xs text-white/50">Android app coming soon.</p>
          </div>
          <div>
